...
public final class BankConstants {
    ...
    // creditRatio: fraction of the player's net worth available as new credit.
    ...
    // ---- Loan term formula ----
    public static final int    BASE_LOAN_TERM         = 48;   // base term in installments (days)
    public static final int    MIN_LOAN_TERM          = 6;
    public static final int    MAX_LOAN_TERM          = 72;
    public static final double TERM_STRENGTH_WEIGHT   = 0.12;
    public static final double TERM_STRESS_WEIGHT     = 0.22;
    public static final double TERM_DISPERSION_WEIGHT = 0.16;
    public static final double TERM_RATE_WEIGHT       = 0.20;
    public static final double TERM_LEVERAGE_WEIGHT   = 18.0; // high leverage reduces available term
    ...
    public static final double TERM_PREMIUM_REFERENCE_INSTALLMENTS = 12.0; // 12-installment loans pay no term premium
